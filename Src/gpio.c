...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED2C4_GPIO_Port, LED2C4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LED2C4_Pin */
  GPIO_InitStruct.Pin = LED2C4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED2C4_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : L_nFAULT_Pin */
  GPIO_InitStruct.Pin = L_nFAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(L_nFAULT_GPIO_Port, &GPIO_InitStruct);
