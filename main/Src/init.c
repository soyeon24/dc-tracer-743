...
menu_t menu[] = {{"1. cali", Sensor_Calibration},{"2. first ", Drive_First }, {"savecm",Change_saveCentiMeter},{"4. secD",Drive_Second }, {"5.pit in",Change_Pit_In},{"6.curverate",Change_curve_rate},{"7.curvedecel", Change_curveDecel},{"setting",Setting_Menu}};
